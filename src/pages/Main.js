        ...
        <div>
            ...
            <div style={{backgroundColor:"#f2f3f5"}}>
                <Container className={"flex-row mt-5 p-lg-5"}>
                    <h1 style={{color:'#333333',fontWeight:"bold",fontSize:60}}>Основная задача <p style={{color:'#04ddb2',lineHeight:0.5}}>приложения</p></h1>
                    <h5 style={{color:'#333333'}} className={"pt-5"}>
                        Приложение переводит сказанное собеседником в текст на экране и озвучивает набранные вручную сообщения.
                    </h5>
                </Container>
            ...
            <Container className={"p-5"}>
                ...
                <Container className={"d-flex flex-wrap"} >
                    ...
                    <Button variant={"success"} style={{borderRadius: 30,backgroundColor:'#04ddb2',border:"none",fontWeight:"bold",fontSize:20,margin:"auto"}} className="mt-5 p-3" onClick={()=> history.push("/blog")}>Читать далее</Button>
                </Container>
            </Container>
            ...
            <div style={{backgroundColor:"#f2f3f5",paddingTop:30,paddingBottom:100}} className={"d-flex flex-row"}>
                <Container style={{marginTop:100,paddingTop:30,paddingLeft:20,paddingRight:20,backgroundColor:'#fff',width:'30%',color:'#333333',fontSize:25,borderRadius:50}} className={"d-flex flex-column hover-zoom"}>
                    ...
                    <span className={"mt-5"}>Спасибо за приложение, очень выручает в некоторых ситуациях, благодарю за возможность пользоваться такой удобной вещью!  </span>
                ...
                <Container style={{marginTop:100,paddingTop:30,paddingLeft:20,paddingRight:20,backgroundColor:'#fff',width:'30%',color:'#333333',fontSize:25,borderRadius:50}} className={"d-flex flex-column hover-zoom"}>
                    ...
                    <span className={"mt-5"}>Спасибо за приложение, очень выручает в некоторых ситуациях, благодарю за возможность пользоваться такой удобной вещью!  </span>
                    <span className={"mt-5"} style={{color:'#989898',paddingBottom:30}}>Дарья Петрова</span>
                </Container>

                <Container style={{marginTop:100,paddingTop:30,paddingLeft:20,paddingRight:20,backgroundColor:'#fff',width:'30%',color:'#333333',fontSize:25,borderRadius:50}} className={"d-flex flex-column hover-zoom"}>
                    <Image src={avatar3} style={{maxWidth:70,borderRadius:100}}></Image>
                    <span className={"mt-5"}>Спасибо за приложение, очень выручает в некоторых ситуациях, благодарю за возможность пользоваться такой удобной вещью!  </span>
                    <span className={"mt-5"} style={{color:'#989898',paddingBottom:30}}>Федор Сидоров</span>
                </Container>
